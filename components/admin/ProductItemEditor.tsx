...
export function ProductItemEditor({
  ...
  return (
    ...
    >
      ...
      <div className="h-20 w-20 shrink-0 overflow-hidden rounded-sm border border-gold/30">
        {item.image ? (
      ...
      <div className="flex flex-1 flex-col gap-2">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <label className="flex items-center gap-2">
            <span className="font-sans text-xs uppercase tracking-wide text-earth">Price (INR)</span>
            <Input
              type="number"
              min={0}
              value={item.price || ''}
